...
def main(args):
    ...
    # creat new src file for testing
    new_file_path = 'bpe_data/prepared/'
    create_bpe_file.make_scrfile_by_srcdict(bpe_dict=src_dict, old_file='data/en-fr/preprocessed/test.fr',
                                               new_pickle=new_file_path+'test.fr')
    create_bpe_file.make_scrfile_by_tardict(bpe_dict=tgt_dict, old_file='data/en-fr/preprocessed/test.en',
                                            new_pickle=new_file_path+'test.en')
